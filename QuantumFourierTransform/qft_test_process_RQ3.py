...
def testing_with_statistical_methods(qubit_list, 
    ...
    '''
        ...
        Input variables:
            ...
            + statistical_methods:  [str]    the concrete OPO, including "MW Test", "Chi Squared", "KS Test", "Crs Ent" 
                                             and "JS Div"
    ...
    for num_qubits in tqdm(qubit_list):           
        ...
        for index in range(total_repeats):     # repeat for statistically significant results
            ...
            for test_order in range(len(df)): 
                ...
                if statistical_method not in ['Crs Ent', 'JS Div']:     # NHTs: generate samples comforting the expected probabilities
